...
// protects the explicit requirement to retain the original Web unchanged.
func TestOriginalCairnAssets(t *testing.T) {
	want := map[string]string{
		"favicon.svg":               "8600d99b56c62e2cb159a6cae0a3bf543906602507770c8e67b85b90fb1473bb",
		"index.html":                "6c6ae6f311347965a53e3045ecdc9ccfcaff26ece581337d2b09d7184930d7e6",
	...
	if count != len(want) {
		t.Fatalf("embedded %d assets, want %d", count, len(want))
	}
}
